...
for size in sizes:
    ...
    ms1_25.to_csv("/home/shantham/scratch/ms1_25_"+str(size)+"_"+fileid+"_607nist17.csv")
    ...
    mrm_7_7_3.to_csv("/home/shantham/scratch/mrm_7_7_3_"+str(size)+"_"+fileid+"_607nist17.csv")
    ...
    swath_25da_25_3.to_csv("/home/shantham/scratch/swath_25da_25_3_"+str(size)+"_"+fileid+"_607nist17.csv")
    ...
    swath_25_25_3.to_csv("/home/shantham/scratch/swath_25_25_3_"+str(size)+"_"+fileid+"_607nist17.csv")
