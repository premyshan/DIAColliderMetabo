...
allcomp20, spectra20 = read('comp_df20.pkl', 'spec_df20.pkl')
allcomp17, spectra17 = read('comp_df17.pkl', 'spec_df17.pkl')
...
allcomp = allcomp20.loc[allcomp20['mol_id'].isin(list(spectra.mol_id))]

#compounds might still exist in nist20 that are in nist17 (additional spec measured)
allcomp = allcomp.loc[~allcomp['inchikey'].isin(allcomp17['inchikey'])]
spectra = spectra.loc[spectra['mol_id'].isin(list(allcomp.mol_id))]

compounds_filt, spectra_filt = filter_comp(allcomp, spectra)

ms1_7 = method_profiler(compounds_filt = compounds_filt.copy(), spectra_filt=spectra_filt.copy(), change=0.7, ppm=0, change_q3 =0, ppm_q3=0, top_n = 0.1, mol_id=0, uis_num=1, q3=False)
ms1_7.to_csv('ms1_7_607nist20sub.csv')

ms1_25 = method_profiler(compounds_filt = compounds_filt.copy(), spectra_filt=spectra_filt.copy(), change=0, ppm=25, change_q3 =0, ppm_q3=0, top_n = 0.1, mol_id=0, uis_num=1, q3=False)
...
prm_20_20_1 = method_profiler(compounds_filt = compounds_filt.copy(), spectra_filt=spectra_filt.copy(),change=2, ppm=0, change_q3 =0, ppm_q3=20, top_n = 0.1, mol_id=0, uis_num=1, q3=True)
prm_20_20_2 = method_profiler(compounds_filt = compounds_filt.copy(), spectra_filt=spectra_filt.copy(),change=2, ppm=0, change_q3 =0, ppm_q3=20, top_n = 0.1, mol_id=0, uis_num=2, q3=True)
prm_20_20_3 = method_profiler(compounds_filt = compounds_filt.copy(), spectra_filt=spectra_filt.copy(),change=2, ppm=0, change_q3 =0, ppm_q3=20, top_n = 0.1, mol_id=0, uis_num=3, q3=True)
